...
import { generateWelcomeLetterPDF } from "../src/lib/pdf/welcomeLetterTemplate.ts";
import { generateAddressChangePDF } from "../src/lib/pdf/addressChangeTemplate.ts";
import { generatePaymentMethodChangePDF } from "../src/lib/pdf/paymentMethodChangeTemplate.ts";
import { generateServiceCertificatePDF } from "../src/lib/pdf/serviceCertificateTemplate.ts";
import { generateSuspensionNoticePDF } from "../src/lib/pdf/suspensionNoticeTemplate.ts";
import { generateCancellationConfirmationPDF } from "../src/lib/pdf/cancellationConfirmationTemplate.ts";
import { generateChargebackNoticePDF } from "../src/lib/pdf/chargebackNoticeTemplate.ts";
import { generateFinalRefundReceiptPDF } from "../src/lib/pdf/finalRefundReceiptTemplate.ts";
import { generateDeliverySlipPDF } from "../src/lib/pdf/deliverySlipTemplate.ts";
import { generateReturnInstructionsPDF } from "../src/lib/pdf/returnInstructionsTemplate.ts";
import { generateInstallationReportPDF } from "../src/lib/pdf/installationReportTemplate.ts";
import { generateActivationConfirmationPDF } from "../src/lib/pdf/activationConfirmationTemplate.ts";
import { generateContractAmendmentPDF } from "../src/lib/pdf/contractAmendmentTemplate.ts";
import { generateFormalDemandPDF } from "../src/lib/pdf/formalDemandTemplate.ts";
import { generateCollectionsTransferPDF } from "../src/lib/pdf/collectionsTransferTemplate.ts";
import { generateComplaintAcknowledgmentPDF } from "../src/lib/pdf/complaintAcknowledgmentTemplate.ts";
import { generatePreauthorizationConfirmationPDF } from "../src/lib/pdf/preauthorizationConfirmationTemplate.ts";
