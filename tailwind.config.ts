    ...
    extend: {
      ...
      colors: {
        ...
        core: {
          ...
          /* ── Ops Console dark surface tokens ── */
          bg: "hsl(var(--core-bg))",
          card: "hsl(var(--core-card))",
          "card-raised": "hsl(var(--core-card-raised))",
          border: "hsl(var(--core-border))",
          "border-strong": "hsl(var(--core-border-strong))",
          muted: "hsl(var(--core-muted))",
          "muted-soft": "hsl(var(--core-muted-soft))",
          fg: "hsl(var(--core-fg))",
          accent: "hsl(var(--core-accent))",
          "accent-soft": "hsl(var(--core-accent-soft))",
          success: "hsl(var(--core-success))",
          warning: "hsl(var(--core-warning))",
          danger: "hsl(var(--core-danger))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
