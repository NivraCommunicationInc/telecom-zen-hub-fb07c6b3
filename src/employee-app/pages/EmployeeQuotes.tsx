/**
 * Employee Quotes List — Browse, filter and manage quotes.
 */
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Gérer les soumissions client</p>
        </div>
        <Button onClick={() => navigate(employeePath("/quotes/new"))} className="gap-2">
