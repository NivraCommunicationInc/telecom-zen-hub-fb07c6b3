...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Professional holding phone — premium prepaid hero */}
      <PhotoBg url="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1920&q=80" opacity={0.15} filter="saturate(0.45) brightness(0.55)" position="center center" />
      <style>{`
        @keyframes aurora-1 {
