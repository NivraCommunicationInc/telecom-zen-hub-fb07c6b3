...
const FinalCTA = () => {
  ...
  return (
    <section style={{ background: '#7C3AED', paddingTop: 48, paddingBottom: 48 }}>
        ...
        <div className="max-w-[700px] mx-auto">
          ...
          <ul className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mb-8 sm:mb-10">
            {[t('finalcta.bullet1'), t('finalcta.bullet2'), t('finalcta.bullet3')].map((text) => (
              <li key={text} className="flex items-center gap-2 font-medium" style={{ color: 'rgba(255,255,255,0.85)', fontSize: 14 }}>
          ...
          <Link
            ...
            style={{ height: 52, borderRadius: 50, background: '#FFFFFF', color: '#7C3AED', fontSize: 15 }}
