...
const FinalCTA = () => {
  ...
  return (
    <section className="py-12 sm:py-20 lg:py-28" style={{ background: '#111111' }}>
        ...
        <div className="max-w-[700px] mx-auto">
          ...
          <ul className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mb-8 sm:mb-10">
            {[t('finalcta.bullet1'), t('finalcta.bullet2'), t('finalcta.bullet3')].map((text) => (
              <li key={text} className="flex items-center gap-2 text-[14px] text-white/70 font-medium">
          ...
          <Link
            to="/commander"
            className="inline-flex items-center justify-center gap-2 px-10 text-[15px] font-bold text-white hover:opacity-90 transition-all"
