    ...
    <section className="py-20 lg:py-28 bg-[#0d0d0d]">
      <div className="container mx-auto px-4 sm:px-6 max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-7 max-w-[920px] mx-auto">
          {points.map((p) => (
            <div key={p.titleKey} className="bg-[#1a1a1a] rounded-2xl p-8 border border-white/10 hover:border-purple-500/30 hover:shadow-[0_0_20px_rgba(139,92,246,0.08)] transition-all duration-300 group">
              ...
              <h3 className="font-bold text-white mb-2">{t(p.titleKey)}</h3>
              <p className="text-sm text-white/60 leading-relaxed">{t(p.textKey)}</p>
            </div>
          ))}
        </div>
      </div>
