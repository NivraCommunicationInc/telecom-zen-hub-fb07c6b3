...
const testimonials = [
  { name: "Marie-Claude B.", location: "Rosemont, Montréal", rating: 5, text: "J'en avais assez de payer 95$ par mois avec un contrat de 2 ans. Avec Nivra, je paie moins et je peux changer quand je veux.", service: "Internet 100 Mbps" },
