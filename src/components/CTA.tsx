  ...
  return (
    <section className="py-20 lg:py-28">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="relative bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-10 lg:p-16 text-center overflow-hidden">
          ...
          <div className="relative">
            ...
            <Button
              className="bg-white text-blue-700 hover:bg-white/90 rounded-full px-8 h-14 text-base font-semibold shadow-xl"
              asChild
            >
              <Link to="/compare">
