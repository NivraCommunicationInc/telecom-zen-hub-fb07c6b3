...
import { useEmployeeNotifications, Notification } from "@/hooks/useEmployeeNotifications";
...
export function EmployeeNotificationBell() {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    // Use employee scope for routing
    const href = getNotificationHref(notification, 'employee');
