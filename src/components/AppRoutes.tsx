...
const AppRoutes = () => {
  return (
    ...
    <Routes>
      ...
      <Route path="/entrevue/:token" element={<MaintenanceGuard><Suspense fallback={<div className="min-h-screen flex items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-primary" /></div>}><InterviewPage /></Suspense></MaintenanceGuard>} />
