...
const CorePublicPaymentsPage = lazy(() => import("@/core-app/pages/CorePublicPaymentsPage"));
...
const AppRoutes = () => {
  return (
    ...
    <Routes>
      ...
      <Route path="/couverture" element={<MaintenanceGuard><PublicLayout><CoverageMap /></PublicLayout></MaintenanceGuard>} />
      ...
      {/* Design preview routes — sandbox redesigns for stakeholder review.
      ...
      <Route path="/portal/orders/:orderId" element={<MaintenanceGuard><ClientAuthProvider><ClientProtectedRoute><ClientSecurityCheck><ClientOrders /></ClientSecurityCheck></ClientProtectedRoute></ClientAuthProvider></MaintenanceGuard>} />
      ...
      <Route path="/portal/loyalty" element={<MaintenanceGuard><ClientAuthProvider><ClientProtectedRoute><ClientSecurityCheck><ClientLoyalty /></ClientSecurityCheck></ClientProtectedRoute></ClientAuthProvider></MaintenanceGuard>} />
      <Route path="/portal/change-plan" element={<MaintenanceGuard><ClientAuthProvider><ClientProtectedRoute><ClientSecurityCheck><ClientChangePlan /></ClientSecurityCheck></ClientProtectedRoute></ClientAuthProvider></MaintenanceGuard>} />
      ...
      <Route path="/core" element={<AuthProvider><Suspense fallback={<div className="min-h-screen bg-[hsl(220,20%,8%)]" />}><CoreProtectedRoute /></Suspense></AuthProvider>}>
        <Route element={<CoreAppLayout />}>
          ...
          <Route path="appointments/slots" element={<Suspense fallback={null}><CoreAppointmentSlotsPage /></Suspense>} />
          ...
          <Route path="public-payments" element={<Suspense fallback={null}><CorePublicPaymentsPage /></Suspense>} />
      ...
      <Route path="/field" element={<AuthProvider><Suspense fallback={<div className="min-h-screen bg-white" />}><FieldProtectedRoute /></Suspense></AuthProvider>}>
        <Route element={<Suspense fallback={null}><FieldAppLayout /></Suspense>}>
          ...
          <Route path="hub/formation" element={<Navigate to="/field/hub?section=formation" replace />} />
