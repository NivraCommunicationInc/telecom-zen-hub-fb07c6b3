...
const PDF_TEMPLATES: PDFTemplateInfo[] = [
  {
    type: "Facture (tous types)",
    templateId: "invoice-v3",
    templateVersion: "V3.0",
    fileName: "src/lib/pdf/invoiceTemplateV3.ts",
    status: "ACTIVE",
    description: "Template TELUS-grade approuve 2026-03-18 — factures mensuelles et uniques",
  },
  {
    type: "Contrat de service",
    templateId: "contract-v3",
    templateVersion: "V3.0",
    fileName: "src/lib/pdf/contractTemplateV3.ts",
    status: "ACTIVE",
    description: "Contrat 4 pages approuve 2026-03-18 — legal avec signatures",
  },
  {
    type: "Recu de paiement",
    templateId: "receipt-v3",
    templateVersion: "V3.0",
    fileName: "src/lib/pdf/receiptTemplate.ts",
    status: "ACTIVE",
    description: "Preuve de paiement avec identite client complete",
  },
  {
    type: "Sommaire de commande",
    templateId: "summary-v3",
    templateVersion: "V3.0",
    fileName: "src/lib/pdf/orderSummaryTemplate.ts",
    status: "ACTIVE",
    description: "Confirmation pre-facturation avec prochaines etapes",
  },
];
