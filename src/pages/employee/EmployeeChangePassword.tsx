...
const EmployeeChangePassword = () => {
  ...
  useEffect(() => {
    const storedEmail = sessionStorage.getItem("employee_email");
    const storedToken = sessionStorage.getItem("employee_temp_token");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      sessionStorage.removeItem("employee_temp_token");
