  ...
  return (
    <div style={{ background: BG, minHeight: '100vh' }} data-testid="mobile-plans-page">
      ...
      <section style={{ paddingTop: 110, paddingBottom: 72, position: 'relative', overflow: 'hidden' }}>
        {/* Person using smartphone — prepaid mobile service */}
        <PhotoBg url="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1920&q=80" opacity={0.14} filter="saturate(0.45) brightness(0.55)" />
