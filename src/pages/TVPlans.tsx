  ...
  return (
    <div style={{ background: BG, minHeight: '100vh' }} data-testid="tv-plans-page">
      ...
      <section style={{ paddingTop: 110, paddingBottom: 72, position: 'relative', overflow: 'hidden' }}>
        {/* Family relaxing and watching TV together — home entertainment */}
        <PhotoBg url="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1920&q=80" opacity={0.14} filter="saturate(0.4) brightness(0.5)" />
