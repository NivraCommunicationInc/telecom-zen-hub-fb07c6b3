  ...
  return (
    <div style={{ background: BG, minHeight: '100vh' }} data-testid="tv-plans-page">
      ...
      <section style={{ paddingTop: 110, paddingBottom: 72, position: 'relative', overflow: 'hidden' }}>
        {/* TV screen glowing in dark room — entertainment experience */}
        <PhotoBg url="https://images.unsplash.com/photo-1574375927538-2101e2987d09?w=1920&q=80" opacity={0.13} filter="saturate(0.4) brightness(0.55)" />
