  ...
  return (
    <div className="min-h-screen" style={{ background: "#020209", position: "relative" }}>
      ...
      <main id="main-content" tabIndex={-1} style={{ position:"relative", zIndex:1 }}>
        ...
        {/* ══ STATS METRICS ══ */}
        <section style={{ background:"#020209", paddingTop:64, paddingBottom:64, borderTop:"1px solid rgba(124,58,237,0.08)" }}>
          <div className="container mx-auto px-4 sm:px-10 max-w-[1200px]">
        ...
        {/* ══ TECHNOLOGIE ══ */}
        <section style={{ background:"#020209", paddingTop:80, paddingBottom:80, borderTop:"1px solid rgba(6,182,212,0.1)" }}>
          <div className="container mx-auto px-4 sm:px-10 max-w-[1200px]">
