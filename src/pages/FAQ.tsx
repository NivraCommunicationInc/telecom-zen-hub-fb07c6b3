  ...
  return (
    <div style={{ background: BG, minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: 110, paddingBottom: 72, position: 'relative', overflow: 'hidden' }}>
        {/* Person on phone with laptop — getting answers */}
        <PhotoBg url="https://images.unsplash.com/photo-1573804633927-bfcbcd909acd?w=1920&q=80" opacity={0.12} filter="saturate(0.4) brightness(0.5)" />
