  ...
  return (
    <div style={{ background: BG, minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: 110, paddingBottom: 72, position: 'relative', overflow: 'hidden' }}>
        {/* Photo bg — server / tech infrastructure */}
        <div aria-hidden style={{ position: 'absolute', inset: 0, backgroundImage: "url('https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1920&q=80')", backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.10, zIndex: 0, pointerEvents: 'none', filter: 'saturate(0.4) brightness(0.6) hue-rotate(200deg)' }} />
