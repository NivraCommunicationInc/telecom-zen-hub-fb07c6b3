  ...
  return (
    <div style={{ background: BG, minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: 110, paddingBottom: 72, position: 'relative', overflow: 'hidden' }}>
        {/* Server room LED glow — tech reliability, deep blue atmosphere */}
        <PhotoBg url="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1920&q=80" opacity={0.14} filter="saturate(0.6) brightness(0.6)" />
