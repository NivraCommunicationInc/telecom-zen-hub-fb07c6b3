  ...
  return (
    <div style={{ background: BG, minHeight: '100vh' }} data-testid="internet-plans-page">
      ...
      <section style={{ paddingTop: 110, paddingBottom: 72, position: 'relative', overflow: 'hidden' }}>
        {/* Person working from home with multiple screens — home internet */}
        <PhotoBg url="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1920&q=80" opacity={0.13} filter="saturate(0.4) brightness(0.5)" />
        {/* Aurora blobs */}
