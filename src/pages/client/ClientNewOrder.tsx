...
Veuillez confirmer les chaînes et procéder à l'activation du service.
      ...
      // Client referral row is created by checkout-canonical-sync edge function (service role)
      // after the order is upserted, avoiding FK violations on referred_order_id.
      // Do NOT insert client_referrals from the client — the canonical sync handles it.
