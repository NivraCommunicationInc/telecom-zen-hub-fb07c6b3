...
const STATUS_CLIENT: Record<string, { label: string; description: string; className: string; icon: typeof Shield }> = {
  ...
  approved: { label: "Vérification approuvée", description: "Vérification approuvée. Vos documents ne sont plus nécessaires pour l'activation. Ils sont maintenant verrouillés (accès restreint) et peuvent être supprimés sur demande.", className: "bg-emerald-50 text-emerald-700 border-emerald-200", icon: CheckCircle2 },
