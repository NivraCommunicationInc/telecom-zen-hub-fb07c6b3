/**
 * FieldSidebar — Navigation for Field Sales portal. Clean light UI.
 */
...
export default function FieldSidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden md:flex flex-col w-56 border-r border-[#E5E7EB] bg-white">
        <div className="h-14 flex items-center px-4 border-b border-[#E5E7EB]">
          <Link to={`${FIELD_BASE}/dashboard`} className="flex items-center gap-2.5">
            <div className="h-7 w-7 rounded-md bg-[#22C55E] flex items-center justify-center">
              <MapPin className="h-3.5 w-3.5 text-white" />
            </div>
            <span className="font-semibold text-sm text-[#000000] tracking-tight">Nivra Field</span>
          </Link>
        </div>
        ...
        <div className="border-t border-[#E5E7EB] py-2 px-2 space-y-0.5">
          ...
          <button
            ...
            className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-md text-[13px] font-medium text-[#6B7280] hover:text-[#DC2626] hover:bg-[#FEF2F2] transition-colors"
          >
