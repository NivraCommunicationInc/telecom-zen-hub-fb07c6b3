...
export const generateTelecomContractPDF = (data: TelecomContractData): jsPDF => {
  ...
  addParagraph(
    `Standard fees (CAD): Activation $${CONTRACT_TERMS.fees.activation.toFixed(2)}, Delivery $${CONTRACT_TERMS.fees.delivery.toFixed(2)}, Reactivation $${CONTRACT_TERMS.fees.reactivation.toFixed(2)}, Nivra 4K Terminal $${CONTRACT_TERMS.fees.tvTerminal.toFixed(2)}, Nivra Born WiFi Router $${CONTRACT_TERMS.fees.router.toFixed(2)}.`
  );
