 ...
 * - NEVER construct objects containing full card number/CVV - use payment processor SDK
 */
...
import { parseExpiry } from './normalize';
...
export function extractCardMetadata(
  ...
  // Use parseExpiry for consistent validation
