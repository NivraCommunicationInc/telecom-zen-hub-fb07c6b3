/**
 * Reactivation Notice (Lettre de réactivation) — browser-side auto-document template.
...
export function generateReactivationNoticePDF(data: ReactivationNoticeData): PDFGenerationResult {
  try {
    ...
    y = drawBoxedText(
      doc,
      "Merci de votre confiance. Pour eviter toute interruption de service future, nous vous recommandons d'activer le paiement automatique depuis votre portail client. Notre equipe reste disponible pour toute question.",
      y,
