...
export const generatePrepaidContractPDF = (data: PrepaidContractData): jsPDF => {
  ...
  addParagraph("Coordonnées support : Support@nivratelecom.ca");
  ...
  addParagraph("Avertissement. Nivra ne demandera jamais le NAS ni des informations complètes de carte de crédit par courriel/téléphone. Signalez toute tentative suspecte à Support@nivratelecom.ca.");

  // Section 10: Plaintes, CRTC et recours externe
  addSectionHeader("10", "Plaintes, CRTC et recours externe");
  addParagraph("Plainte interne. Le Client doit d'abord contacter Nivra via Support@nivratelecom.ca et/ou le portail client.");
