...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'hero.title1': 'Télécoms fiables. Installation rapide.',
    'hero.title2': 'Support humain.',
    'hero.subtitle': 'Mobile, Internet, Télévision et Sécurité — une mise en service claire, un support réactif, et des services qui fonctionnent au quotidien.',
    'hero.cta.order': 'Demander un service',
    'hero.cta.services': 'Nous joindre',
    'hero.trust.activation': 'Activation rapide',
    'hero.trust.installation': 'Installation planifiée',
    'hero.trust.support': 'Support local',
    'hero.trust.solutions': 'Résidentiel & entreprise',
    ...
    'services.mobile.desc': 'Forfaits et lignes mobiles. Activation et support, sans complications.',
    'services.internet.title': 'Internet',
    'services.internet.desc': 'Internet haute performance. Installation sur rendez-vous, assistance technique.',
    'services.tv.title': 'Télévision',
    'services.tv.desc': 'TV et options. Mise en service et support pour vos équipements.',
    'services.business.title': 'Sécurité',
    'services.business.desc': 'Solutions de sécurité connectées. Installation et accompagnement.',
    ...
    'benefits.independent.desc': 'Activation, installation et support — tout géré par notre équipe.',
    'benefits.savings.title': 'Réponse rapide',
    'benefits.savings.desc': 'Suivi clair et délais maîtrisés.',
    'benefits.simple.title': 'Fiable et structuré',
    'benefits.simple.desc': 'Processus simple, communication professionnelle.',
    'benefits.support.title': 'Résidentiel et entreprise',
    ...
    'howitworks.step1.desc': 'Vous nous indiquez vos besoins.',
    'howitworks.step2.title': 'Prise en charge',
    'howitworks.step2.desc': 'On confirme et planifie l\'installation si nécessaire.',
    ...
    'cta.subtitle.order': 'Envoyez votre demande et notre équipe s\'occupe de la mise en service.',
    'cta.phone': 'Nous joindre',
    
    // Contact Form
    'contact.title': 'Demande de service',
    'contact.subtitle': 'Décrivez votre besoin — notre équipe vous répond rapidement.',
    ...
    'about.title2': 'Nivra',
    'about.subtitle': 'Fournisseur télécom indépendant au Québec. Services internes, modèle client-payeur, service direct.',
    'about.mission.title': 'Notre mission',
    'about.mission.text': 'Offrir des services télécom fiables aux Québécois — activation, installation et support.',
  ...
  en: {
    ...
    'hero.title1': 'Reliable telecom. Fast installation.',
    'hero.title2': 'Human support.',
    'hero.subtitle': 'Mobile, Internet, Television and Security — clear setup, responsive support, and services that work every day.',
    ...
    'hero.trust.support': 'Local support',
    ...
    'services.mobile.title': 'Mobile',
    'services.mobile.desc': 'Mobile plans and lines. Activation and support, hassle-free.',
    'services.internet.title': 'Internet',
    'services.internet.desc': 'High-performance Internet. Scheduled installation, technical support.',
    'services.tv.title': 'Television',
    'services.tv.desc': 'TV and options. Setup and support for your equipment.',
    'services.business.title': 'Security',
    'services.business.desc': 'Connected security solutions. Installation and guidance.',
    ...
    'benefits.independent.desc': 'Activation, installation and support — all managed by our team.',
    'benefits.savings.title': 'Fast response',
    'benefits.savings.desc': 'Clear follow-up and controlled timelines.',
    'benefits.simple.title': 'Reliable and structured',
    ...
    'cta.subtitle.order': 'Send your request and our team handles the setup.',
    'cta.phone': 'Contact us',
    
    // Contact Form
    'contact.title': 'Service request',
    'contact.subtitle': 'Describe your needs — our team will respond quickly.',
