...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'benefits.title': 'Un fournisseur télécom structuré',
    'benefits.subtitle': 'Processus clair, installation planifiée et support réactif.',
    'benefits.independent.title': 'Service encadré',
    'benefits.independent.desc': 'Processus clair, suivi et documentation.',
    'benefits.savings.title': 'Installation planifiée',
    'benefits.savings.desc': 'Rendez-vous, technicien, mise en service.',
    'benefits.simple.title': 'Support humain',
    'benefits.simple.desc': 'Réponse rapide, assistance technique.',
    'benefits.support.title': 'Résidentiel et entreprise',
    'benefits.support.desc': 'Solutions adaptées à vos besoins réels.',
  ...
  en: {
    ...
    'benefits.title': 'A structured telecom provider',
    'benefits.subtitle': 'Clear process, scheduled installation and responsive support.',
    'benefits.independent.title': 'Structured service',
    'benefits.independent.desc': 'Clear process, follow-up and documentation.',
    'benefits.savings.title': 'Scheduled installation',
    'benefits.savings.desc': 'Appointment, technician, service setup.',
    'benefits.simple.title': 'Human support',
    'benefits.simple.desc': 'Fast response, technical assistance.',
    'benefits.support.title': 'Home and business',
    'benefits.support.desc': 'Solutions adapted to your real needs.',
