...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'hero.title1': 'Connectivité fiable. Support rapide.',
    'hero.title2': 'Solutions télécoms qui fonctionnent.',
    'hero.subtitle': 'Mobile, Internet, TV et sécurité — activation, installation et assistance, au même endroit.',
    'hero.cta.order': 'Demander une soumission',
    'hero.cta.services': 'Nous joindre',
    'hero.trust.activation': 'Activation rapide',
    'hero.trust.installation': 'Installation sur rendez-vous',
    'hero.trust.support': 'Support humain',
    'hero.trust.solutions': 'Particuliers & entreprises',
    
    // Services
    'services.badge': 'Nos services',
    'services.title': 'Services télécom Nivra',
    'services.subtitle': 'Activation, installation et support — tout au même endroit.',
    'services.mobile.title': 'Mobile',
    'services.mobile.desc': 'Forfaits mobiles et gestion de lignes.',
    'services.internet.title': 'Internet',
    'services.internet.desc': 'Internet résidentiel et business.',
    'services.tv.title': 'Télévision',
    'services.tv.desc': 'TV et options de chaînes.',
    'services.business.title': 'Sécurité',
    'services.business.desc': 'Solutions de sécurité et surveillance.',
    'services.cta': 'Demander une soumission',
    'services.mobile.feature1': 'Activation / transfert de numéro',
    'services.mobile.feature2': 'Ajout de lignes & gestion multi-utilisateurs',
    'services.mobile.feature3': 'Assistance configuration (eSIM, APN, etc.)',
    'services.internet.feature1': 'Installation planifiée',
    'services.internet.feature2': 'Optimisation Wi-Fi & configuration routeur',
    'services.internet.feature3': 'Support en cas de panne',
    'services.tv.feature1': 'Mise en service',
    'services.tv.feature2': 'Configuration équipement',
    'services.tv.feature3': 'Assistance et suivi',
    'services.business.feature1': 'Recommandations selon le besoin',
    ...
    'benefits.title': 'Un fournisseur télécom de confiance',
    'benefits.subtitle': 'Activation, installation et support — service clé en main pour particuliers et entreprises.',
    'benefits.independent.title': 'Service clé en main',
    'benefits.independent.desc': 'Activation, installation et support — tout géré par nous.',
    'benefits.savings.title': 'Réponse rapide',
    'benefits.savings.desc': 'Suivi clair et délais maîtrisés.',
    'benefits.simple.title': 'Fiable & structuré',
    'benefits.simple.desc': 'Processus simple, communication professionnelle.',
    'benefits.support.title': 'Maison et entreprise',
    'benefits.support.desc': 'Solutions adaptées à votre réalité.',
    'benefits.stat.satisfaction': 'Clients satisfaits',
    'benefits.stat.clients': 'Clients actifs',
    'benefits.stat.quebec': 'Support Québec',
    'benefits.trust.local': 'Entreprise québécoise',
    ...
    'howitworks.step1.desc': 'Vous nous dites ce dont vous avez besoin.',
    'howitworks.step2.title': 'Activation / Planification',
    'howitworks.step2.desc': 'On confirme et on planifie l\'installation si nécessaire.',
    'howitworks.step3.title': 'Mise en service',
    'howitworks.step3.desc': 'Tout est configuré, vous êtes opérationnel.',
    
    // CTA
    'cta.badge': 'Prêt à activer votre service?',
    'cta.title.order': 'Prêt à activer votre service?',
    'cta.subtitle.order': 'Demandez une soumission et on s\'occupe de la mise en service.',
    'cta.phone': 'Nous joindre',
    
    // Contact Form
    'contact.title': 'Demander une soumission',
    'contact.subtitle': 'Décrivez votre besoin et on vous répond rapidement.',
    ...
    'contact.success.title': 'Merci pour votre demande!',
    ...
    'about.title2': 'Nivra',
    'about.subtitle': 'Fournisseur télécom indépendant au Québec. Services Nivra internes, modèle client-payeur, aucune affiliation carrier.',
    'about.mission.title': 'Notre mission',
    'about.mission.text': 'Vendre nos propres services télécom aux Québécois, sans intermédiaire ni carrier.',
  ...
  en: {
    ...
    'hero.title1': 'Reliable connectivity. Fast support.',
    'hero.title2': 'Telecom solutions that work.',
    'hero.subtitle': 'Mobile, Internet, TV and security — activation, installation and support, all in one place.',
    'hero.cta.order': 'Request a quote',
    'hero.cta.services': 'Contact us',
    'hero.trust.activation': 'Fast activation',
    'hero.trust.installation': 'Scheduled installation',
    'hero.trust.support': 'Human support',
    'hero.trust.solutions': 'Home & business',
    
    // Services
    'services.badge': 'Our Services',
    'services.title': 'Nivra Telecom Services',
    'services.subtitle': 'Activation, installation and support — all in one place.',
    'services.mobile.title': 'Mobile',
    'services.mobile.desc': 'Mobile plans and line management.',
    'services.internet.title': 'Internet',
    'services.internet.desc': 'Residential and business Internet.',
    'services.tv.title': 'Television',
    'services.tv.desc': 'TV and channel options.',
    'services.business.title': 'Security',
    'services.business.desc': 'Security and surveillance solutions.',
    'services.cta': 'Request a quote',
    'services.mobile.feature1': 'Activation / number transfer',
    'services.mobile.feature2': 'Add lines & multi-user management',
    'services.mobile.feature3': 'Configuration assistance (eSIM, APN, etc.)',
    'services.internet.feature1': 'Scheduled installation',
    'services.internet.feature2': 'Wi-Fi optimization & router configuration',
    'services.internet.feature3': 'Outage support',
    'services.tv.feature1': 'Service setup',
    'services.tv.feature2': 'Equipment configuration',
    'services.tv.feature3': 'Assistance and follow-up',
    'services.business.feature1': 'Needs-based recommendations',
    ...
    'benefits.title': 'A trusted telecom provider',
    'benefits.subtitle': 'Activation, installation and support — turnkey service for home and business.',
    'benefits.independent.title': 'Turnkey service',
    'benefits.independent.desc': 'Activation, installation and support — all managed by us.',
    'benefits.savings.title': 'Fast response',
    'benefits.savings.desc': 'Clear follow-up and controlled timelines.',
    'benefits.simple.title': 'Reliable & structured',
    'benefits.simple.desc': 'Simple process, professional communication.',
    'benefits.support.title': 'Home and business',
    'benefits.support.desc': 'Solutions adapted to your reality.',
    'benefits.stat.satisfaction': 'Satisfied Clients',
    'benefits.stat.clients': 'Active Clients',
    'benefits.stat.quebec': 'Quebec Support',
    'benefits.trust.local': 'Quebec-based company',
    ...
    'howitworks.step1.title': 'Quote request',
    'howitworks.step1.desc': 'Tell us what you need.',
    'howitworks.step2.title': 'Activation / Planning',
    'howitworks.step2.desc': 'We confirm and schedule installation if needed.',
    'howitworks.step3.title': 'Service setup',
    'howitworks.step3.desc': 'Everything is configured, you\'re operational.',
    
    // CTA
    'cta.badge': 'Ready to activate your service?',
    'cta.title.order': 'Ready to activate your service?',
    'cta.subtitle.order': 'Request a quote and we\'ll handle the setup.',
    'cta.phone': 'Contact us',
    
    // Contact Form
    'contact.title': 'Request a quote',
    'contact.subtitle': 'Describe your needs and we\'ll respond quickly.',
