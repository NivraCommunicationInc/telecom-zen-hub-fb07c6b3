...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'services.internet.feature2': 'Frais équipement unique',
    ...
    'benefits.title': 'Votre fournisseur télécom de confiance',
    'benefits.subtitle': 'Nivra est un fournisseur indépendant qui vend ses propres services télécom au Québec. Modèle 100% client-payeur, sans intermédiaire.',
    'benefits.independent.title': 'Services intégrés',
    'benefits.independent.desc': 'Nous gérons tout en interne : de la commande au support technique, pour une expérience simplifiée.',
    'benefits.savings.title': 'Tarification transparente',
    'benefits.savings.desc': 'Aucun frais caché, aucune surprise. Nos prix sont clairs dès le départ.',
    'benefits.simple.title': 'Inscription rapide',
    'benefits.simple.desc': 'Commandez en ligne en quelques minutes. Pièce d\'identité requise, sans vérification de crédit.',
    'benefits.support.title': 'Support dédié',
    'benefits.support.desc': 'Une équipe québécoise disponible pour vous accompagner via votre portail client.',
    ...
    'cta.title.order': 'Commandez vos services Nivra',
    'cta.subtitle.order': 'Créez votre compte et passez commande en ligne. Pièce d\'identité requise.',
  ...
  en: {
    ...
    'services.internet.feature2': 'One-time equipment fee',
    ...
    'benefits.title': 'Your trusted telecom provider',
    'benefits.subtitle': 'Nivra is an independent provider selling its own telecom services in Quebec. 100% client-paid model, no intermediary.',
    'benefits.independent.title': 'Integrated Services',
    'benefits.independent.desc': 'We manage everything in-house: from ordering to technical support, for a simplified experience.',
    'benefits.savings.title': 'Transparent Pricing',
    'benefits.savings.desc': 'No hidden fees, no surprises. Our prices are clear from the start.',
    'benefits.simple.title': 'Quick Sign-up',
    'benefits.simple.desc': 'Order online in minutes. ID required, no credit check.',
    'benefits.support.title': 'Dedicated Support',
    'benefits.support.desc': 'A Quebec-based team available to assist you through your client portal.',
    ...
    'cta.title.order': 'Order Your Nivra Services',
    'cta.subtitle.order': 'Create your account and order online. ID required.',
    'cta.phone': 'Call Us',
