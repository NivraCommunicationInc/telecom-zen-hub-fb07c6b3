...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    // Hero
    'hero.badge': 'Fournisseur télécom indépendant au Québec',
    'hero.title1': 'Vos services télécoms',
    'hero.title2': 'simplifiés',
    ...
    'services.title': 'Services télécom internes Nivra',
    'services.subtitle': 'Des services vendus directement par Nivra, sans intermédiaire ni affiliation carrier.',
    'services.mobile.title': 'Téléphonie mobile',
    'services.mobile.desc': 'Forfaits mobiles Nivra adaptés à vos besoins.',
    'services.internet.title': 'Internet résidentiel',
    'services.internet.desc': 'Connexion haute vitesse Nivra pour votre domicile.',
    'services.tv.title': 'Télévision',
    'services.tv.desc': 'Forfaits TV Nivra avec chaînes au choix.',
    'services.business.title': 'Solutions entreprises',
    'services.business.desc': 'Services télécom Nivra pour entreprises québécoises.',
    'services.cta': 'Réserver une consultation',
    'services.mobile.feature1': 'Forfaits flexibles',
    'services.mobile.feature2': 'Sans vérification crédit',
    'services.mobile.feature3': 'Pièce d\'identité requise',
    'services.internet.feature1': 'Haute vitesse',
    'services.internet.feature2': 'Installation incluse',
    'services.internet.feature3': 'Support navigateur',
    'services.tv.feature1': 'Chaînes HD',
    'services.tv.feature2': 'Forfaits modulables',
    'services.tv.feature3': 'Terminal Nivra 4K',
    'services.business.feature1': 'Audit télécom',
    'services.business.feature2': 'Frais transparents',
    'services.business.feature3': 'Support dédié',
    
    // Benefits
    'benefits.badge': 'Pourquoi Nivra',
    'benefits.title': 'Un fournisseur télécom indépendant',
    'benefits.subtitle': 'Nivra vend ses propres services. Aucune affiliation carrier, aucune commission externe.',
    'benefits.independent.title': 'Services internes',
    'benefits.independent.desc': 'Nivra vend ses propres services télécom. Modèle client-payeur à 100%.',
    'benefits.savings.title': 'Tarifs clairs',
    'benefits.savings.desc': 'Frais transparents, sans surprise ni commission cachée.',
    'benefits.simple.title': 'Processus simple',
    ...
    'benefits.stat.savings': 'Services Nivra',
    'benefits.stat.experience': 'Au Québec',
    
    // How it works
    'howitworks.badge': 'Comment ça marche',
    'howitworks.title': 'Un processus simple en 4 étapes',
    'howitworks.subtitle': 'Commandez vos services Nivra facilement, sans vérification de crédit.',
    'howitworks.step1.title': 'Consultation gratuite',
    'howitworks.step1.desc': 'Échange de 30 minutes pour évaluer vos besoins télécom.',
    'howitworks.step2.title': 'Choix de services',
    'howitworks.step2.desc': 'Sélectionnez parmi les forfaits Nivra disponibles.',
    'howitworks.step3.title': 'Validation d\'identité',
    'howitworks.step3.desc': 'Téléversement de pièce d\'identité gouvernementale pour confirmer votre commande.',
    'howitworks.step4.title': 'Activation',
    'howitworks.step4.desc': 'Vos services Nivra sont activés. Accès et support via navigateur uniquement.',
    ...
    // Footer
    'footer.description': 'Fournisseur télécom indépendant au Québec. Services Nivra internes, modèle client-payeur, aucune affiliation carrier.',
  ...
  en: {
    ...
    // Hero
    'hero.badge': 'Independent Telecom Provider in Quebec',
    'hero.title1': 'Your telecom services',
    ...
    'services.title': 'Internal Nivra Telecom Services',
    'services.subtitle': 'Services sold directly by Nivra, no intermediary or carrier affiliation.',
    'services.mobile.title': 'Mobile Phone',
    'services.mobile.desc': 'Nivra mobile plans tailored to your needs.',
    'services.internet.title': 'Residential Internet',
    'services.internet.desc': 'Nivra high-speed connection for your home.',
    'services.tv.title': 'Television',
    'services.tv.desc': 'Nivra TV packages with channels of your choice.',
    'services.business.title': 'Business Solutions',
    'services.business.desc': 'Nivra telecom services for Quebec businesses.',
    'services.cta': 'Book a consultation',
    'services.mobile.feature1': 'Flexible plans',
    'services.mobile.feature2': 'No credit check',
    'services.mobile.feature3': 'ID required',
    'services.internet.feature1': 'High speed',
    'services.internet.feature2': 'Installation included',
    'services.internet.feature3': 'Browser support',
    'services.tv.feature1': 'HD channels',
    'services.tv.feature2': 'Modular packages',
    'services.tv.feature3': 'Nivra 4K Terminal',
    'services.business.feature1': 'Telecom audit',
    'services.business.feature2': 'Transparent fees',
    'services.business.feature3': 'Dedicated support',
    
    // Benefits
    'benefits.badge': 'Why Nivra',
    'benefits.title': 'An independent telecom provider',
    'benefits.subtitle': 'Nivra sells its own services. No carrier affiliation, no external commission.',
    'benefits.independent.title': 'Internal Services',
    'benefits.independent.desc': 'Nivra sells its own telecom services. 100% client-paid model.',
    'benefits.savings.title': 'Clear Pricing',
    'benefits.savings.desc': 'Transparent fees, no surprises or hidden commissions.',
    'benefits.simple.title': 'Simple Process',
    ...
    'benefits.stat.savings': 'Nivra Services',
    'benefits.stat.experience': 'In Quebec',
    
    // How it works
    'howitworks.badge': 'How It Works',
    'howitworks.title': 'A simple 4-step process',
    'howitworks.subtitle': 'Order your Nivra services easily, no credit check required.',
    'howitworks.step1.title': 'Free Consultation',
    'howitworks.step1.desc': '30-minute call to assess your telecom needs.',
    'howitworks.step2.title': 'Choose Services',
    'howitworks.step2.desc': 'Select from available Nivra packages.',
    'howitworks.step3.title': 'ID Validation',
    'howitworks.step3.desc': 'Upload government ID to confirm your order.',
    'howitworks.step4.title': 'Activation',
    'howitworks.step4.desc': 'Your Nivra services are activated. Access and support via browser only.',
    ...
    // Footer
    'footer.description': 'Independent telecom provider in Quebec. Internal Nivra services, client-paid model, no carrier affiliation.',
    'footer.services': 'Services',
