...
const OrdersPage = () => (
  <div className="space-y-5">
    <div>
      ...
      <p className="text-[13px] text-[hsl(220,10%,50%)] mt-0.5">Gestion des commandes Nivra</p>
    </div>
    ...
    <div className="flex items-center gap-3">
      <div className="flex-1 flex items-center gap-2 rounded-lg border border-[hsl(220,15%,16%)] bg-[hsl(220,20%,11%)] px-3 py-2">
        ...
        <span className="text-[13px] text-[hsl(220,10%,35%)]">Rechercher une commande…</span>
      </div>
      ...
      <table className="w-full text-[13px]">
        <thead>
          <tr className="border-b border-[hsl(220,15%,16%)]">
            {["N° commande", "Client", "Service", "Statut", "Date", "Montant"].map((h) => (
