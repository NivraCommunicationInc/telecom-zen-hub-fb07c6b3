...
const CoreAppointmentDetail = lazy(() => import("./pages/CoreAppointmentDetail"));
...
const CoreGrilleCanaux = lazy(() => import("./pages/CoreGrilleCanaux"));
...
const CoreLoyaltyPage = lazy(() => import("./pages/CoreLoyaltyPage"));
...
const HrSchedulesPage = lazy(() => import("./pages/hr/HrSchedulesPage"));
const HrDocumentsPage = lazy(() => import("./pages/hr/HrDocumentsPage"));
const HrTaxDocumentsPage = lazy(() => import("./pages/hr/HrTaxDocumentsPage"));
const HrRequestsPage = lazy(() => import("./pages/hr/HrRequestsPage"));
const HrAuditPage = lazy(() => import("./pages/hr/HrAuditPage"));
          ...
          <Routes>
            ...
            <Route path="/" element={<CoreProtectedRoute />}>
              <Route element={<CoreAppLayout />}>
                ...
                <Route path="appointments/:id" element={<S><CoreAppointmentDetail /></S>} />
                ...
                <Route path="grille-canaux" element={<S><CoreGrilleCanaux /></S>} />
                ...
                <Route path="loyalty" element={<S><CoreLoyaltyPage /></S>} />
                {/* Support */}
