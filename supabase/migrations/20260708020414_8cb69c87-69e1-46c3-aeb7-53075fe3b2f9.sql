...
BEGIN
  ...
  -- Canonical cycle_end = anchor_day - 1 of the following month.
  v_cycle_end       := (v_activation_date + INTERVAL '1 month' - INTERVAL '1 day')::date;
  v_next_renewal    := (v_activation_date + INTERVAL '1 month');
  ...
  IF v_existing_sub_id IS NOT NULL THEN
    ...
    SET
      ...
      next_renewal_at = COALESCE(bs.next_renewal_at, v_next_renewal),
