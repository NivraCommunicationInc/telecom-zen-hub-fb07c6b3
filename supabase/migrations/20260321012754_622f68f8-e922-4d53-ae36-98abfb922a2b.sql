...
-- FIX: compute_invoice_breakdown was capping discounts to services_subtotal_cents only.
-- This is wrong for discounts like EQUIP26 that apply to equipment/fees.
-- The cap should be against the FULL subtotal (all non-discount lines).
...
BEGIN
  ...
  -- FIX: Cap discount to FULL subtotal (not just services).
  -- Discounts like EQUIP26 apply to equipment/fees, not services.
  -- The cap prevents negative taxable amounts but does NOT restrict scope.
