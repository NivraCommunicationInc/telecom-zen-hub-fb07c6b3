...
BEGIN
  ...
  INSERT INTO public.billing_subscriptions (
    ...
    environment, source_type, source_id, source_order_item_id,
...
GRANT EXECUTE ON FUNCTION public.rpc_qa_seed_subscription_fixture(jsonb) TO service_role;

INSERT INTO public.billing_subscription_writer_allowlist (function_name, allowed_operations, category, notes)
VALUES ('rpc_qa_seed_subscription_fixture', ARRAY['INSERT'], 'qa', 'QA fixture seed (env=test only)')
