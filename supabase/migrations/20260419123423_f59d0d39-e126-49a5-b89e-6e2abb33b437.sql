-- Replace the invalid 'cycle' enum reference in the reactivation fee trigger.
-- Valid billing_invoice_type values: initial | renewal | adjustment | credit
...
BEGIN
  ...
  -- Only renewal invoices are eligible for reactivation fee
  ...
  -- Use 'adjustment' type for reactivation fee (valid enum)
  ...
  -- Create reactivation fee invoice (type='adjustment' since 'reactivation_fee' is not a valid enum)
