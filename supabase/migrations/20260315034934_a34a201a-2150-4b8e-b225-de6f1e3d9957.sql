ALTER TABLE public.promotions ADD COLUMN IF NOT EXISTS duration_months integer DEFAULT NULL;

-- Also update compute_checkout_pricing to include duration_months in promo_applied output
