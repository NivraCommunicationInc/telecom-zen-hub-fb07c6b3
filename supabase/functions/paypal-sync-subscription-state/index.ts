// ============================================================================
// paypal-sync-subscription-state — DÉSACTIVÉ (Phase 3.B.2)
// ============================================================================
...
serve((req) => {
  ...
  return new Response(
    JSON.stringify({
      ...
      message:
        "PayPal est désactivé. Utilisez Square (`(N/A — désactivé)`) pour tout nouveau paiement.",
      replaced_by: "(N/A — désactivé)",
      phase: "3.B.2",
    }),
