// ============================================================================
// billing-paypal-retry-failed — DÉSACTIVÉ (Phase 3.B.2)
// ============================================================================
...
//
// Remplacement : square-autopay-retry
//
...
serve((req) => {
  ...
  return new Response(
    JSON.stringify({
      ...
      message:
        "PayPal est désactivé. Utilisez Square (`square-autopay-retry`) pour tout nouveau paiement.",
      replaced_by: "square-autopay-retry",
      phase: "3.B.2",
    }),
