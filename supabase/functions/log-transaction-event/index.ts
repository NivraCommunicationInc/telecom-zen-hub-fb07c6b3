...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data, error } = await adminClient.from("transaction_events").insert({
      ...
      metadata: {
        ...metadata,
        provider_order_id: body.provider_order_id ?? metadata.provider_order_id ?? null,
        provider_capture_id: body.provider_capture_id ?? metadata.provider_capture_id ?? null,
      },
