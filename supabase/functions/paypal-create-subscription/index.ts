// ============================================================================
// paypal-create-subscription — DÉSACTIVÉ (Phase 3.B.2)
// ============================================================================
...
//
// Remplacement : square-charge-subscription
//
...
serve((req) => {
  ...
  return new Response(
    JSON.stringify({
      ...
      message:
        "PayPal est désactivé. Utilisez Square (`square-charge-subscription`) pour tout nouveau paiement.",
      replaced_by: "square-charge-subscription",
      phase: "3.B.2",
    }),
