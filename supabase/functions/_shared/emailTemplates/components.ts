      ...
      <table role="presentation" cellpadding="0" cellspacing="0" style="width: 100%;">
        ...
        <tr>
          <td style="text-align: center; padding-bottom: 16px;">
            <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
              <tr>
                <td style="padding: 0 8px;"><a href="https://nivratelecom.ca" style="color: ${colors.footerLink}; font-size: 12px; text-decoration: none;">Site web</a></td>
                <td style="color: ${colors.footerText};">|</td>
                <td style="padding: 0 8px;"><a href="https://nivratelecom.ca/privacy" style="color: ${colors.footerLink}; font-size: 12px; text-decoration: none;">Confidentialité</a></td>
                <td style="color: ${colors.footerText};">|</td>
                <td style="padding: 0 8px;"><a href="https://nivratelecom.ca/terms" style="color: ${colors.footerLink}; font-size: 12px; text-decoration: none;">Conditions</a></td>
              </tr>
            </table>
          </td>
        </tr>
