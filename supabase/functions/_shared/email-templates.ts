// ============================================================================
// SHARED EMAIL TEMPLATES — Extracted for deployment size optimization
// DO NOT modify email template content without approval.
// ============================================================================
...
export const detailsCard = (items: Array<{ label: string; value: string }>) => `
...
export const statusBadge = (type: 'success' | 'warning' | 'error' | 'info', _icon: string, titleFr: string, titleEn: string, messageFr: string, messageEn: string) => {
  const colors = {
...
export const emailTemplates: Record<string, { subject: string; getHtml: (vars: Record<string, any>, config: EmailConfig) => string }> = {
