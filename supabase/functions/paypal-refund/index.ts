// ============================================================================
// paypal-refund — DÉSACTIVÉ (Phase 3.B.2)
// ============================================================================
...
//
// Remplacement : (remboursement manuel via Square)
//
...
serve((req) => {
  ...
  return new Response(
    JSON.stringify({
      ...
      message:
        "PayPal est désactivé. Utilisez Square (`(remboursement manuel via Square)`) pour tout nouveau paiement.",
      replaced_by: "(remboursement manuel via Square)",
      phase: "3.B.2",
    }),
