// ============================================================================
// core-paypal-order-link — DÉSACTIVÉ (Phase 3.B.2)
// ============================================================================
...
//
// Remplacement : core-square-payment-link
//
...
serve((req) => {
  ...
  return new Response(
    JSON.stringify({
      ...
      message:
        "PayPal est désactivé. Utilisez Square (`core-square-payment-link`) pour tout nouveau paiement.",
      replaced_by: "core-square-payment-link",
      phase: "3.B.2",
    }),
